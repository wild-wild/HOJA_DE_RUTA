...
export const CONVALIDACIONES = [
    ...
    ["INF152", "COMPUTACIÓN II", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ["LEN301", "LENGUA NATIVA I", "ELECTIVA", "OPT 002", "LENGUA NATIVA", "ELECTIVA", "HOMOLOGACIÓN", null],
    ["LEN321", "LENGUA NATIVA II", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ["LEN401", "LENGUA NATIVA III", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ["LEN421", "LENGUA NATIVA IV", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ["LIN110", "IDIOMA INGLÉS I", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ["LIN111", "IDIOMA INGLÉS II", "ELECTIVA", "s/n", "s/n", "s/n", "ELIMINADA", null],
    ...
    ["s/n", "s/n", "s/n", "PSI 711", "INTERVENCIÓN CLÍNICA PSICOANALÍTICA", "SÉPTIMO SEMESTRE", "CONVALIDACIÓN", null],
    ...
    ["s/n", "s/n", "s/n", "PPP 100", "PRÁCTICA PRE PROFESIONAL", "NOVENO SEMESTRE", "NUEVA", null],
    ["s/n", "s/n", "s/n", "BIO 523", "PSICOLINGUISTICA", "QUINTO SEMESTRE", "NUEVA", null],
    ["s/n", "s/n", "s/n", "GRL 001", "MODALIDAD DE GRADUACIÓN", "DÉCIMO SEMESTRE", "NUEVA ASIGNATURA", null],
    ["s/n", "s/n", "s/n", "GDI 001", "GRADUACIÓN DIRECTA", "DÉCIMO SEMESTRE", "NUEVA ASIGNATURA", null],
    ["s/n", "s/n", "s/n", "OPT 010", "SOCIOPATOLOGÍA", "ELECTIVA", "NUEVA ASIGNATURA", null],
    ["s/n", "s/n", "s/n", "OPT 011", "PSICOTERAPIA INFANTIL", "ELECTIVA", "NUEVA ASIGNATURA", null],
];
