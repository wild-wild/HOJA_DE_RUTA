...
const CONVALIDACIONES = [
  ...
  [
    "CSO250",
    "PSICOLOGÍA GRUPAL Y ORGANIZACIONAL",
    "CUARTO SEMESTRE",
    "CSO 524",
  ...
  [
    "CSO401",
    "TÉCNICAS DE INTERVENCIÓN SOCIO-ORGANIZACIONAL I",
    "SÉPTIMO SEMESTRE",
    "PSI 634",
  ...
  [
    "PSI400",
    "TECNICAS DE INTERVENCION CLINICA I",
    "SÉPTIMO SEMESTRE",
    "PSI 611",
    "PSICOLOGÍA CLÍNICA",
    "SEXTO SEMESTRE",
  ...
  [
    "PSI402",
    "TÉCNICAS DE INTERVENCIÓN EDUCACIONAL I",
    "SÉPTIMO SEMESTRE",
    "PSI 815",
  ...
  [
    ...
    "OCTAVO SEMESTRE",
    "PSI 614",
    "INTERVENCIÓN ORGANIZACIONAL RECURSOS HUMANOS I",
    "SEXTO SEMESTRE",
    "HOMOLOGACIÓN",
    3,
  ],
  ...
  [
    "PSI450",
    "TECNICAS DE INTERVENCION CLINICA II",
    "OCTAVO SEMESTRE",
    "PSI 817",
  ...
  [
    "PSI452",
    "TECNICAS DE INTERVENCION EDUCACIONAL II",
    "OCTAVO SEMESTRE",
    "PSI 918",
  ...
  [
    "INV501",
    "TALLER DE GRADO DE TRABAJO DIRIGIDO I",
    "NOVENO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    "INV502",
    "TALLER DE GRADO DE PROYECTO SOCIAL I",
    "NOVENO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    ...
    "NOVENO SEMESTRE",
    "PSI 712",
    "INTERVENCIÓN CLÍNICA HUMANISTA",
    "SÉPTIMO SEMESTRE",
    "COMPENSACIÓN",
    null,
  ],
  ...
  [
    "PSI502",
    "ABORDAJE SOCIO ORGANIZACIONAL I",
    "NOVENO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    ...
    "NOVENO SEMESTRE",
    "PSI 816",
    "INTERVENCIÓN CLÍNICA COGNITIVO CONDUCTUAL I",
    "OCTAVO SEMESTRE",
    "HOMOLOGACIÓN",
    null,
  ],
  ...
  [
    "PSI505",
    "ABORDAJE SOCIO-ORGANIZACIONAL II",
    "DÉCIMO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    ...
    "DÉCIMO SEMESTRE",
    "PSI 912",
    "INTERVENCIÓN CLÍNICA COGNITIVO CONDUCTUAL II",
    "NOVENO SEMESTRE",
    "HOMOLOGACIÓN",
    null,
  ],
  ...
  [
    "INV504",
    "TALLER DE GRADO DE TRABAJO DIRIGIDO II",
    "DÉCIMO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    "INV505",
    "TALLER DE GRADO DE PROYECTO SOCIAL II",
    "DÉCIMO SEMESTRE",
    "",
    "",
    "",
  ...
  [
    "ANT301",
    "TERRITORIOS EN LOS PUEBLOS INDÍGENAS BOLIVIANOS",
    "TALLER",
    "",
    "",
    "",
  ...
  [
    "ANT302",
    "RELAC.INTERÉTNICAS Y ETNICIDAD",
    "TALLER",
    "",
    "",
    "",
  ...
  [
    "CSA202",
    "SOCIEDAD DE LA INFANCIA, ADOLESCENCIA Y JUVENTUD",
    "TALLER",
    "OPT 004",
  ...
  [
    "CSA203",
    "SOCIOLOGÍA DE LA ORGANIZACIÓN Y TRABAJO",
    "TALLER",
    "",
    "",
    "",
  ...
  [
    "INFORME",
    "PRÁCTICAS REALIZADAS EN DIRECCIÓN DE CARRERA E INSTITUCIONES O UNIDADES",
    "PRÁCTICAS",
    "PPP 100",
...
function buildCardNueva(it) {
  ...
  if (aprobada) {
    const max = Math.max(
      ...it.origs
        .filter((o) => o.nota != null && !isNaN(Number(o.nota)))
        .map((o) => Number(o.nota)),
    );
    notaLabel = `✓ ${max}`;
  } else if (tieneNota) {
...
function actualizarModalMalla() {
  ...
  function cardMatModal(sigla, nombre, notaVal, esPendientePool) {
    ...
    let notaTag = '';
    if (aprobada) notaTag = `<span class="mm-nota mm-nota-ok"><i class="fa-solid fa-circle-check"></i> ${n}</span>`;
    else if (reprobada) notaTag = `<span class="mm-nota mm-nota-fail"><i class="fa-solid fa-circle-xmark"></i> ${n}</span>`;
  ...
  if (plan === '148-2') {
    ...
    SEMS_NUEVA_MODAL.forEach(sec => {
      ...
      const cards = items.map(it => {
        ...
        return cardMatModal(it.siglaNueva, it.nombreNueva, notaForCard, esPend);
      }).join('');
